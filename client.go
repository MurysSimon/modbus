...
func (mc *ModbusClient) ReadCoils(addr uint16, quantity uint16) (values []bool, txRaw []byte, rxRaw []byte, err error) {
	values, txRaw, rxRaw, err = mc.readBools(addr, quantity, false)

	return
}

// Reads a single coil (function code 01).
func (mc *ModbusClient) ReadCoil(addr uint16) (value bool, txRaw []byte, rxRaw []byte, err error) {
	var values []bool

	values, txRaw, rxRaw, err = mc.readBools(addr, 1, false)
	if err == nil {
		value = values[0]
	}
...
func (mc *ModbusClient) ReadDiscreteInputs(addr uint16, quantity uint16) (values []bool, txRaw []byte, rxRaw []byte, err error) {
	values, txRaw, rxRaw, err = mc.readBools(addr, quantity, true)

	return
}

// Reads a single discrete input (function code 02).
func (mc *ModbusClient) ReadDiscreteInput(addr uint16) (value bool, txRaw []byte, rxRaw []byte, err error) {
	var values []bool

	values, txRaw, rxRaw, err = mc.readBools(addr, 1, true)
	if err == nil {
		value = values[0]
	}
...
func (mc *ModbusClient) ReadRegisters(addr uint16, quantity uint16, regType RegType) (values []uint16, txRaw []byte, rxRaw []byte, err error) {
	var mbPayload []byte

	// read quantity uint16 registers, as bytes
	mbPayload, txRaw, rxRaw, err = mc.readRegisters(addr, quantity, regType)
	if err != nil {
		return
	}
...
func (mc *ModbusClient) ReadRegister(addr uint16, regType RegType) (value uint16, txRaw []byte, rxRaw []byte, err error) {
	var values []uint16

	// read 1 uint16 register, as bytes
	values, txRaw, rxRaw, err = mc.ReadRegisters(addr, 1, regType)
	if err == nil {
		value = values[0]
	}
...
func (mc *ModbusClient) ReadUint32s(addr uint16, quantity uint16, regType RegType) (values []uint32, txRaw []byte, rxRaw []byte, err error) {
	var mbPayload []byte

	// read 2 * quantity uint16 registers, as bytes
	mbPayload, txRaw, rxRaw, err = mc.readRegisters(addr, quantity*2, regType)
	if err != nil {
		return
	}
...
func (mc *ModbusClient) ReadUint32(addr uint16, regType RegType) (value uint32, txRaw []byte, rxRaw []byte, err error) {
	var values []uint32

	values, txRaw, rxRaw, err = mc.ReadUint32s(addr, 1, regType)
	if err == nil {
		value = values[0]
	}
...
func (mc *ModbusClient) ReadFloat32s(addr uint16, quantity uint16, regType RegType) (values []float32, txRaw []byte, rxRaw []byte, err error) {
	var mbPayload []byte
...
func (mc *ModbusClient) ReadFloat32(addr uint16, regType RegType) (value float32, txRaw []byte, rxRaw []byte, err error) {
	var values []float32

	values, txRaw, rxRaw, err = mc.ReadFloat32s(addr, 1, regType)
	if err == nil {
		value = values[0]
	}
...
func (mc *ModbusClient) ReadUint64s(addr uint16, quantity uint16, regType RegType) (values []uint64, txRaw []byte, rxRaw []byte, err error) {
	var mbPayload []byte

	// read 4 * quantity uint16 registers, as bytes
	mbPayload, txRaw, rxRaw, err = mc.readRegisters(addr, quantity*4, regType)
	if err != nil {
		return
	}
...
func (mc *ModbusClient) ReadUint64(addr uint16, regType RegType) (value uint64, txRaw []byte, rxRaw []byte, err error) {
	var values []uint64

	values, txRaw, rxRaw, err = mc.ReadUint64s(addr, 1, regType)
	if err == nil {
		value = values[0]
	}
...
func (mc *ModbusClient) ReadFloat64s(addr uint16, quantity uint16, regType RegType) (values []float64, txRaw []byte, rxRaw []byte, err error) {
	var mbPayload []byte
...
func (mc *ModbusClient) ReadFloat64(addr uint16, regType RegType) (value float64, txRaw []byte, rxRaw []byte, err error) {
	var values []float64

	values, txRaw, rxRaw, err = mc.ReadFloat64s(addr, 1, regType)
	if err == nil {
		value = values[0]
	}
...
func (mc *ModbusClient) ReadBytes(addr uint16, quantity uint16, regType RegType) (values []byte, txRaw []byte, rxRaw []byte, err error) {
	values, txRaw, rxRaw, err = mc.readBytes(addr, quantity, regType, true)
...
func (mc *ModbusClient) ReadRawBytes(addr uint16, quantity uint16, regType RegType) (values []byte, txRaw []byte, rxRaw []byte, err error) {
	values, txRaw, rxRaw, err = mc.readBytes(addr, quantity, regType, false)

	return
}

// Writes a single coil (function code 05)
func (mc *ModbusClient) WriteCoil(addr uint16, value bool) (txRaw []byte, rxRaw []byte, err error) {
	var req *pdu
	var res *pdu
	...
	res, txRaw, rxRaw, err = mc.executeRequest(req)
	if err != nil {
		return
	}
...
func (mc *ModbusClient) WriteCoils(addr uint16, values []bool) (txRaw []byte, rxRaw []byte, err error) {
	var req *pdu
	var res *pdu
	var quantity uint16
...
func (mc *ModbusClient) WriteRegister(addr uint16, value uint16) (txRaw []byte, rxRaw []byte, err error) {
	var req *pdu
	var res *pdu
...
func (mc *ModbusClient) WriteRegisters(addr uint16, values []uint16) (txRaw []byte, rxRaw []byte, err error) {
	var payload []byte
	...
	txRaw, rxRaw, err = mc.writeRegisters(addr, payload)

	return
}

// Writes multiple 32-bit registers.
func (mc *ModbusClient) WriteUint32s(addr uint16, values []uint32) (txRaw []byte, rxRaw []byte, err error) {
	var payload []byte
...
func (mc *ModbusClient) WriteUint32(addr uint16, value uint32) (txRaw []byte, rxRaw []byte, err error) {
	txRaw, rxRaw, err = mc.writeRegisters(addr, uint32ToBytes(mc.endianness, mc.wordOrder, value))

	return
}

// Writes multiple 32-bit float registers.
func (mc *ModbusClient) WriteFloat32s(addr uint16, values []float32) (txRaw []byte, rxRaw []byte, err error) {
	var payload []byte
...
func (mc *ModbusClient) WriteFloat32(addr uint16, value float32) (txRaw []byte, rxRaw []byte, err error) {
	txRaw, rxRaw, err = mc.writeRegisters(addr, float32ToBytes(mc.endianness, mc.wordOrder, value))

	return
}

// Writes multiple 64-bit registers.
func (mc *ModbusClient) WriteUint64s(addr uint16, values []uint64) (txRaw []byte, rxRaw []byte, err error) {
	var payload []byte
...
func (mc *ModbusClient) WriteUint64(addr uint16, value uint64) (txRaw []byte, rxRaw []byte, err error) {
	txRaw, rxRaw, err = mc.writeRegisters(addr, uint64ToBytes(mc.endianness, mc.wordOrder, value))

	return
}

// Writes multiple 64-bit float registers.
func (mc *ModbusClient) WriteFloat64s(addr uint16, values []float64) (txRaw []byte, rxRaw []byte, err error) {
	var payload []byte
...
func (mc *ModbusClient) WriteFloat64(addr uint16, value float64) (txRaw []byte, rxRaw []byte, err error) {
	txRaw, rxRaw, err = mc.writeRegisters(addr, float64ToBytes(mc.endianness, mc.wordOrder, value))
...
func (mc *ModbusClient) WriteBytes(addr uint16, values []byte) (txRaw []byte, rxRaw []byte, err error) {
	txRaw, rxRaw, err = mc.writeBytes(addr, values, true)
...
// Odd byte quantities are padded with a null byte to fall on 16-bit register boundaries.
func (mc *ModbusClient) WriteRawBytes(addr uint16, values []byte) (txRaw []byte, rxRaw []byte, err error) {
	txRaw, rxRaw, err = mc.writeBytes(addr, values, false)
...
/*** unexported methods ***/
// Reads one or multiple 16-bit registers (function code 03 or 04) as bytes.
func (mc *ModbusClient) readBytes(addr uint16, quantity uint16, regType RegType, observeEndianness bool) (values []byte, txRaw []byte, rxRaw []byte, err error) {
	var regCount uint16
	...
	values, txRaw, rxRaw, err = mc.readRegisters(addr, regCount, regType)
	if err != nil {
		return
	}
...
// Writes the given slice of bytes to 16-bit registers starting at addr.
func (mc *ModbusClient) writeBytes(addr uint16, values []byte, observeEndianness bool) (txRaw []byte, rxRaw []byte, err error) {
	...
	txRaw, rxRaw, err = mc.writeRegisters(addr, values)
...
func (mc *ModbusClient) readBools(addr uint16, quantity uint16, di bool) (values []bool, txRaw []byte, rxRaw []byte, err error) {
	var req *pdu
	var res *pdu
	var expectedLen int
...
func (mc *ModbusClient) readRegisters(addr uint16, quantity uint16, regType RegType) (bytes []byte, txRaw []byte, rxRaw []byte, err error) {
	var req *pdu
	var res *pdu
...
func (mc *ModbusClient) writeRegisters(addr uint16, values []byte) (txRaw []byte, rxRaw []byte, err error) {
	var req *pdu
	var res *pdu
...
func (mc *ModbusClient) executeRequest(req *pdu) (res *pdu, txRaw []byte, rxRaw []byte, err error) {
	// send the request over the wire, wait for and decode the response
	res, txRaw, rxRaw, err = mc.transport.ExecuteRequest(req)
	if err != nil {
